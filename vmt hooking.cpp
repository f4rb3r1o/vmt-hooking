// ExploitEducation.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
//#define WRITE_HOOK_FUNC 1
//#define PAYLOAD 
// BYTE payload[16] = { 0x68, 0X00, 0X00, 0X00, 0X00, 0x68, 0x00, 0x00, 0x00, 0x00, 0x68, 0x00, 0x00, 0x00, 0x00, 0xc3 }; // PUSH pid, PUSH back_to_address, PUSH hook_function_address, RET

//void* HookFunc_ptr;
LPVOID AllocPayloadMem(HANDLE Process);

unsigned writeProcessMem(HANDLE processHandle, void * hookFuncAddr, void * vmtAddr, void * trampoline); // write opcode/hook_function_ptr to target process address space
// opcodes args : flags , address_dst 
// hook_function_ptr : flags, address_dst (vmt entry)
